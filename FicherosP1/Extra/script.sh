...
if [ ! -e file4.dat ]; then
	touch file4.dat                  
	dd count=8 if=/dev/zero of=file4.dat
fi

./../mytar -c -f mytar.mtar file1.txt file2.txt file3.dat file4.dat #creamos el comprimido con los tres archivos

#./../mytar -rf mytar.mtar file1.txt
...
if diff ../file4.dat file4.dat >/dev/null ; then
