 ...
 */
	...
	while(dbridge.cars_on_bridge >= LENGTH || (dbridge.cur_direction != dcar->my_direction && dbridge.cars_on_bridge != 0)){
 ...
 */
	...
	if(dbridge.cars_waiting[dcar->my_direction]>0) pthread_cond_signal(&dbridge.VCs[dcar->my_direction]);
